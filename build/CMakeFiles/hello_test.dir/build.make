...
CMakeFiles/hello_test.dir/hello_test.cc.o: ../hello_test.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/volume/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/hello_test.dir/hello_test.cc.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/hello_test.dir/hello_test.cc.o -c /volume/hello_test.cc
...
CMakeFiles/hello_test.dir/hello_test.cc.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /volume/hello_test.cc > CMakeFiles/hello_test.dir/hello_test.cc.i
...
CMakeFiles/hello_test.dir/hello_test.cc.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /volume/hello_test.cc -o CMakeFiles/hello_test.dir/hello_test.cc.s
...
hello_test: CMakeFiles/hello_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/volume/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable hello_test"
	$(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/hello_test.dir/link.txt --verbose=$(VERBOSE)
	/usr/bin/cmake -D TEST_TARGET=hello_test -D TEST_EXECUTABLE=/volume/build/hello_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/volume/build -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=hello_test_TESTS -D CTEST_FILE=/volume/build/hello_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -P /usr/share/cmake-3.16/Modules/GoogleTestAddTests.cmake
...
CMakeFiles/hello_test.dir/depend:
	cd /volume/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /volume /volume /volume/build /volume/build /volume/build/CMakeFiles/hello_test.dir/DependInfo.cmake --color=$(COLOR)
